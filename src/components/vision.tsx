    ...
    return (
        <>
            <section className="container mx-auto py-8 md:py-0 md:pb-16">
                <h2 className="text-center text-primary text-xl font-semibold tracking-[1.9px] uppercase font-raleway">OUR VISION</h2>
                ...
                <p className="my-8 lg:mt-5 lg:mb-16  text-[#8a8a8a] text-center text-lg font-poppins  ">Explainable AI (XAI) is an emerging subject of machine learning research that refers to strategies that try to provide transparency to typically opaque AI models and their predictions.</p>
                <div className=" flex flex-col ">


                    <div className="flex items-start gap-5 lg:w-1/2 pb-16 lg:border-r-4 border-dashed">
                        <div>
                            <h3 className="text-[28px] font-bold font-poppins my-5">Diversity & Fairness</h3>
                            <p className="text-tertiary font-poppins transition-none  ">When training our AI models, we consider ethical and social implications of algorithm-based decision making. Our solutions use high-quality and fairly-represented data sets to eliminate human cognitive biases.</p>
                        </div>
                        <div className=" rounded-full border-[4px] border-[#717171] inline-block py-1 px-[1px] lg:relative -right-6 bg-white">
                    ...
                    <div className=" flex lg:justify-end " >
                        <div className="lg:w-1/2 flex items-start gap-5 lg:border-l-4 border-dashed relative right-[2px] pb-16 " >
                            <div className=" rounded-full border-[4px] border-[#717171] inline-block py-[5px] px-[1px] lg:relative right-6 bg-white">
                    ...
                    <div className="flex items-start gap-5 lg:w-1/2">
                        <div>
                            <h3 className="text-[28px] font-bold font-poppins my-5">Code of Ethics</h3>
                            <p className="text-tertiary font-poppins transition-none  ">LENS believes in a just, non-violent world of equality and fairness. We prize democratic values, civil liberties and open and informed debate. When used to further these values, algorithm-based decision-making models can continue to make the world a safer, better place for everyone.</p>
                        </div>
                        <div className=" rounded-full border-[4px] border-[#717171] inline-block py-1 px-[1px] lg:relative left-6">
