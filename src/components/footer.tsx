                        ...
                        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
                            ...
                            <div className="flex flex-col  max-md:items-center ">
                                <div className="flex max-md:items-center max-md:justify-center">
                                    <div className="relative aspect-[20/17] w-20 mt-1 mb-5 flex max-md:items-center ">
                            ...
                            <div className="flex flex-col gap-5 max-md:items-center font-poppins">
                                ...
                                <Link className="font-poppins hover:bg-gradient-to-br from-blue-500 to-blue-200 hover:linear-bg text-sm bg-clip-text" href={'/'}>Life at LENS</Link>
                            </div>
                            <div className="flex flex-col gap-5 max-md:items-center">
                                ...
                                <Link className="font-poppins hover:bg-gradient-to-br from-blue-500 to-blue-200   hover:linear-bg text-sm bg-clip-text" href={'mailto:solutions@lenscorp.ai'}>solutions@lenscorp.ai</Link>
                            </div>
